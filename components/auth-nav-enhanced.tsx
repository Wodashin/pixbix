    ...
    return (
      <DropdownMenu>
        ...
        <DropdownMenuContent className="w-80 bg-slate-800 border-slate-700" align="end" forceMount>
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center space-x-1 mt-1">
                ...
                <span className="text-xs text-slate-400">
                  {daysSinceJoined === 0 ? "Nuevo hoy" : `${daysSinceJoined} días en PixBae`}
                </span>
              </div>
            </div>
          </div>
          ...
          {/* Opciones del menú - Usando enlaces HTML directos */}
          <a href="/perfil" className="block w-full">
          ...
          <a href="/configuracion" className="block w-full">
            <DropdownMenuItem className="text-slate-300 hover:bg-slate-700 cursor-pointer">
